 ...
 * automatique (investigation manuelle), jamais {success:true} sans DELETE réel.
 *
 * Adapté depuis packages/legal/src/api/cron-account-deletion.ts. Corrige CONFORMITE.md
 * Gap #5 (dossier vide, 404 en prod — aucun cron ne traitait la suppression différée).
 */
