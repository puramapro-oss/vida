      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="glass rounded-3xl p-8 md:p-12 space-y-10 text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            ...
            <p>
              SASU PURAMA (ci-après &quot;nous&quot;) exploite la plateforme VIDA accessible à l&apos;adresse <strong className="text-[var(--text-primary)]">vida.purama.dev</strong>.
          ...
          <section>
            ...
            <p>Nous collectons les données suivantes lors de votre utilisation de VIDA :</p>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 ml-4 list-disc">
              ...
              <li>Fourniture des services VIDA (chat IA, génération de contenus, agents)</li>
          ...
          <section>
            ...
            <p className="mt-3">
              Pour exercer ces droits, rendez-vous dans <strong className="text-[var(--text-primary)]">Paramètres → Compte → Données personnelles</strong> de votre espace VIDA, ou contactez notre DPO à : <a href="mailto:matiss.frasne@gmail.com" className="text-[var(--cyan)] hover:underline">matiss.frasne@gmail.com</a>.
            </p>
            <p className="mt-2">
