  ...
  return (
    <div
      ...
      className={cn(
        ...
        spotlight && 'before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[radial-gradient(400px_circle_at_var(--spotlight-x)_var(--spotlight-y),rgba(16,185,129,0.06),transparent_60%)]',
        'hover:border-[var(--border-glow)] hover:shadow-[0_0_30px_rgba(16,185,129,0.1)]',
        className
      )}
      {...props}
    >
